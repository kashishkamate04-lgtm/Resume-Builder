...
const Footer = () => {
  return (
    <>
      ...
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-5 md:gap-10 py-8 px-6 md:px-10 lg:px-20 xl:px-30 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to white mt-40">
