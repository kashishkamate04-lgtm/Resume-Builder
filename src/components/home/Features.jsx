...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
        ...
        <Title title="Build your resume" description="Our streamlined process makes it easy to create a professional resume in minutes with intelligent AI-powred tools and features." />

            <div className="flex flex-col md:flex-row items-center xl:-mt-10">0
